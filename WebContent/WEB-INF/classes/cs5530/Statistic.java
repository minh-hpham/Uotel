...
public class Statistic {
	...
	public String mostPopular(String m, Statement stmt) {
		...
		try {
			...
			output.append("Most popular housing for every category:<br>");
			while (!list.isEmpty()) {
	...
	public String mostExpensive(String m, Statement stmt) {
		...
		try {
			...
			while(rs.next())
				list.push(rs.getString(1));
			output.append("Most expansive housing for every category:<br>");
			while (!list.isEmpty()) {
				String category = list.pop();
	...
	public String highlyRated(String m, Statement stmt) {
		...
		try {
			...
			output.append("Most highly rated housing for every category:<br>");
